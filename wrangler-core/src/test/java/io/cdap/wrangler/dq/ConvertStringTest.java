...
public void testremoveWhiteSpace() {
    ...
    // Print Unicode characters for clarity
    ...
    // Make sure the expected string uses correct escaped Unicode
    String expected1 = "a\u0085b\u00A0c\u1680d\u180Ee\u2000f\u2001g\u2002h\u2003i\u2004";
    Assert.assertEquals(expected1, cleanStr); 

    input = "a\u2005\u2005\u2005b\u2006\u2006c\u2007\u2007d\u2008\u2008e\u2009\u2009f\u200A\u200Ag"
           + "\u2028\u2028h\u2029\u2029i\u202F\u202Fj\u205F\u205Fk\u3000\u3000l";
    cleanStr = convertString.removeRepeatedWhitespaces(input);

    // Same here — use a variable for the expected string
    String expected2 = "a\u2005b\u2006c\u2007d\u2008e\u2009f\u200Ag\u2028h\u2029i\u202Fj\u205Fk\u3000l";
    Assert.assertEquals(expected2, cleanStr); 
}
